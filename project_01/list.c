...
#include "list.h"
#include "math.h"
// Тут мы считываем указатели и добавляем числа
...
// Тут мы добавляем элемент списка для входных данных
...
// Вот тут мы добавляем элементы списка для выходных данных
